...
import com.spring.websellspringmvc.models.shoppingCart.CartProduct;
import com.spring.websellspringmvc.models.shoppingCart.CartProductCustom;
...
//        String sql = """
//                SELECT id, discountPercent, `code`, minimumPrice, `description`
//                FROM vouchers WHERE expiryDate >= CURDATE() AND availableTurns > 0 AND `code` = ?
//                """;
...
//        List<Integer> cartIds = GeneralDAO.executeQueryWithSingleTable(sql, com.spring.websellspringmvc.models.shoppingCart.Cart.class, userId).stream()
