...
//        //tách thành list object và list<list<string>>
////        Map<Object, List<String>> mapOrderFilter = (Map<Object, List<String>>) request.getAttribute("mapOrderFilter");
//        String[] paymentMethod = (String[]) request.getAttribute("CheckedPaymentMethods");
//        String[] orderStatus = (String[]) request.getAttribute("CheckedOrderStatus");
//        String[] transactionStatus = (String[]) request.getAttribute("CheckedTransactionStatus");
...
//
//        List<Order> listOrderById = AdminOrderServices.getINSTANCE().getListOrdersBySearchFilter(paymentMethod, orderStatus, transactionStatus, contentSearch, searchSelected, startDateFiltered, endDateFiltered);
