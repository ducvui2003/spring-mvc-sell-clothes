...
//
//        List<Order> listOrderByCustomerName = AdminOrderServices.getINSTANCE().getListOrdersBySearchFilter(paymentMethod, orderStatus, transactionStatus, contentSearch, searchSelected, startDateFiltered, endDateFiltered);
//
