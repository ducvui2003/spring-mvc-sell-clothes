...
<div id="main" class="d-flex">
    ...
    <div class="px-4 mt-4 w-100">
        <div class="row">
            <div class="col-lg-9">
                <div class="card mb-4">
                    <div class="card-header">Thông tin khóa ${requestScope.hasKey}</div>
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="4" name="currentKey" id="currentKey"
                                      placeholder="Hãy cập nhật khóa công khai của bạn!"
                                      disabled>${requestScope.keys[0].publicKey}</textarea>
                        </div>
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <c:if test="${requestScope.hasKey == true}">
                                <button class="btn btn-danger" type="button" data-bs-toggle="modal" id="reportKeyBtn"
            ...
            <div class="col-lg-3">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="small mb-0 d-inline-flex align-items-center" for="currentKey">Tải công cụ<span class="ms-1 button--hover" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                          data-bs-custom-class="custom-tooltip"
                                          data-bs-title="Khóa công khai."><i
                                        class="fa-regular fa-circle-question"></i></span></label>
                        ...
                        <div class="d-flex justify-content-start">
                            <button class="btn btn-primary me-3" type="button" data-bs-toggle="modal"
                                    data-bs-target="#addKeyModal">Tải phần mềm
                            </button>
...
<div class="modal fade text-black" id="addKeyModal" tabindex="-1" aria-labelledby="staticBackdropLabel"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" style="max-width: 80%">
        <form id="form-add-key" class="modal-content" enctype="multipart/form-data">
            <input type="text" value="${requestScope.keys[0].id}" id="currentKeyId" hidden>
            <div class="modal-header">
